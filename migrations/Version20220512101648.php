 ...
 */
final class Version20220512101648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_statut_id INT NOT NULL, numero_commande INT NOT NULL, date_commande DATETIME NOT NULL, INDEX IDX_6EEAA67D76158423 (id_statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE flux (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, quantite INT NOT NULL, date_flux DATETIME NOT NULL, origine INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, part_number VARCHAR(15) NOT NULL, denomination VARCHAR(255) NOT NULL, fournisseur VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, prix_unitaire DOUBLE PRECISION NOT NULL, stock_min INT DEFAULT NULL, stock_max INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
